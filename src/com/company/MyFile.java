...
class MyFile {
    ...
    public static void setPermissions(String path, String permissions) {
        try {
            if (!path.contains(" ")) {
                System.out.println(path + ":not found"); return;
            }
            String permission = path.substring(path.length() - 3);
            ...
            if (permission.charAt(0) == 'r' ) {
               if (!file.setReadable(true)) System.out.println("Read permission denied!");
            }
